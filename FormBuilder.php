...
class FormBuilder extends FormConfigBuilder implements \IteratorAggregate, FormBuilderInterface
{
     ...
     * {@inheritdoc}
     */
    public function addS($child, string $placeholder = "    " )
    {
        $options = [
            'label'=> false,
            'attr' =>   [
            ...
            return $this->add($child, null, $options );
    }
    
    /**
     * {@inheritdoc}
     */
    public function addD($child, string $placeholder = "    " )
    {
        $options = [
            'widget' => 'single_text',
            'attr' => [
        ...
        return $this->add($child, DateType::class, $options );
    }
    
    /**
     * {@inheritdoc}
     */
    public function addE($child, string $placeholder = "email" )
    {
        $options = [
            'label'=> false,
            'attr' =>   [
            ...
            return $this->add($child, EmailType::class, $options );
    }
