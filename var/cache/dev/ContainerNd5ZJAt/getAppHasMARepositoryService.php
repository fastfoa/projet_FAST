 ...
 */
class getAppHasMARepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AppHasMARepository' shared autowired service.
     *
     * @return \App\Repository\AppHasMARepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AppHasMARepository.php';

        return $container->privates['App\\Repository\\AppHasMARepository'] = new \App\Repository\AppHasMARepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
