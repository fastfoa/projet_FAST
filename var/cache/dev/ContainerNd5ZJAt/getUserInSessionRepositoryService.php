 ...
 */
class getUserInSessionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserInSessionRepository' shared autowired service.
     *
     * @return \App\Repository\UserInSessionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserInSessionRepository.php';

        return $container->privates['App\\Repository\\UserInSessionRepository'] = new \App\Repository\UserInSessionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
