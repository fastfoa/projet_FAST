 ...
 */
class getRecipientDocumentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecipientDocumentRepository' shared autowired service.
     *
     * @return \App\Repository\RecipientDocumentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecipientDocumentRepository.php';

        return $container->privates['App\\Repository\\RecipientDocumentRepository'] = new \App\Repository\RecipientDocumentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
