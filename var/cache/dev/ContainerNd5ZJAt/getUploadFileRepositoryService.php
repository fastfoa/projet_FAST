 ...
 */
class getUploadFileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UploadFileRepository' shared autowired service.
     *
     * @return \App\Repository\UploadFileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UploadFileRepository.php';

        return $container->privates['App\\Repository\\UploadFileRepository'] = new \App\Repository\UploadFileRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
