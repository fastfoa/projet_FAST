...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CompteModifPasswordController' => 'getCompteModifPasswordControllerService',
            'App\\Controller\\DashController' => 'getDashControllerService',
            'App\\Controller\\DocumentController' => 'getDocumentControllerService',
            'App\\Controller\\EvaluationController' => 'getEvaluationControllerService',
            'App\\Controller\\InscriptionController' => 'getInscriptionControllerService',
            'App\\Controller\\LanController' => 'getLanControllerService',
            'App\\Controller\\ProfilController' => 'getProfilControllerService',
            'App\\Controller\\ProfilEnabledController' => 'getProfilEnabledControllerService',
            'App\\Controller\\RGPDController' => 'getRGPDControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\StageFormController' => 'getStageFormControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8Od49L7p8Q', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JvdlZdfcY0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VYAQ1SEly0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AppHasMARepository' => ['privates', 'App\\Repository\\AppHasMARepository', 'getAppHasMARepositoryService', true],
            'App\\Repository\\ComboNomSessionRepository' => ['privates', 'App\\Repository\\ComboNomSessionRepository', 'getComboNomSessionRepositoryService', true],
            ...
            'App\\Repository\\EvaluationRepository' => ['privates', 'App\\Repository\\EvaluationRepository', 'getEvaluationRepositoryService', true],
            'App\\Repository\\FormationRepository' => ['privates', 'App\\Repository\\FormationRepository', 'getFormationRepositoryService', true],
            'App\\Repository\\FormationsRepository' => ['privates', 'App\\Repository\\FormationsRepository', 'getFormationsRepositoryService', true],
            'App\\Repository\\MAHasEntRepository' => ['privates', 'App\\Repository\\MAHasEntRepository', 'getMAHasEntRepositoryService', true],
            'App\\Repository\\RecipientDocumentRepository' => ['privates', 'App\\Repository\\RecipientDocumentRepository', 'getRecipientDocumentRepositoryService', true],
            'App\\Repository\\SessionRepository' => ['privates', 'App\\Repository\\SessionRepository', 'getSessionRepositoryService', true],
            'App\\Repository\\UploadFileRepository' => ['privates', 'App\\Repository\\UploadFileRepository', 'getUploadFileRepositoryService', true],
            'App\\Repository\\UserInSessionRepository' => ['privates', 'App\\Repository\\UserInSessionRepository', 'getUserInSessionRepositoryService', true],
            ...
            'App\\Repository\\ComboNomSessionRepository' => '?',
            ...
            'App\\Repository\\UploadFileRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wN4dPDZ2Yy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oaqgyfcs1M', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BKbpa+G5C9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vnNHgjdCno', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('siAU2Oqt4q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'path_upload' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'public'.\DIRECTORY_SEPARATOR.'files'),
            'loginDB' => 'root',
            'PasswordDB' => '',
