 ...
 */
class getComboNomSessionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComboNomSessionRepository' shared autowired service.
     *
     * @return \App\Repository\ComboNomSessionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComboNomSessionRepository.php';

        return $container->privates['App\\Repository\\ComboNomSessionRepository'] = new \App\Repository\ComboNomSessionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
