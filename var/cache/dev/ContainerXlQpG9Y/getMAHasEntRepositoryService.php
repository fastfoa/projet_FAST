 ...
 */
class getMAHasEntRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MAHasEntRepository' shared autowired service.
     *
     * @return \App\Repository\MAHasEntRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MAHasEntRepository.php';

        return $container->privates['App\\Repository\\MAHasEntRepository'] = new \App\Repository\MAHasEntRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
